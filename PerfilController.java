...
/**
 *
 * @author Álvaro Morales García
 */
@WebServlet(name = "PerfilController", urlPatterns = {"/comunidad"})
public class PerfilController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getServletContext().setAttribute("log_usuario", user);
        request.getServletContext().setAttribute("log_pwd", new_pwd);
        request.getServletContext().setAttribute("biografia", biografia);
